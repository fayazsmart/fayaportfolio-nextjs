...
const [isScroll, setIsScroll] = useState(false)
  ...
  return (
    ...
    <div className='fixed top-0 right-0 w-11/12 -z-10 translate-y-[-80%]'>
      ...
      flex items-center justify-between z-50 ${isScroll ? "bg-white bg-opacity-50 blackdrop-blue-lg shadow-sm" :""}`}>
        <a href="#top">
           <h1 className=' bg-gradient-to-r from-purple-600 via-indigo-500 to-blue-400 
            text-transparent  bg-clip-text  transition duration-300 
             text-4xl w-28 mr-4 cursor-text '>Fayaa </h1>
        </a>
         ...
         <div className='flex items-center gap-4'>
          {/*twat  */}
            ...
            px-10 py-2.5 border border-gray-500 rounded-full ml-4 font-Ovo'>Contact <Image src={assets.arrow_icon} alt=''
             className='w-3'/></a>
